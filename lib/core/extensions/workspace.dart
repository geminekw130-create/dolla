    ...
    if (permissionGranted == PermissionStatus.denied) {
      ...
      if (permissionGranted == PermissionStatus.denied) {
        showOpenAppSettingsDialog(
            context, "Por favor, permita acesso à localização nas configurações.");
        return;
      }
    }
...
getUserDataLocallyToHandleTheState(BuildContext context,
    {bool? isHomePage}) async {
      ...
      try {
        ...
        if (loginModel?.data != null) {
          ...
          if (userData.itemId != null) {
            ...
            context.read<UpdateAddEditVehicleIdCubit>().updateItemId(
                vehicleAddEditTypeId: loginModel!.data!.itemId!);
          }
          ...
          if (box.get('itemTypeId') == true) {
            if (documentApprovedStatus == "approved") {
              ...
              Navigator.pushReplacement(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      const SetupInitialScreen(stepIndex: 2),
                ),
              );
            }
          } else {
            Navigator.pushReplacement(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    const SetupInitialScreen(stepIndex: 1),
              ),
            );
          }
        } else {
