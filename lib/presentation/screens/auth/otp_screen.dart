      ...
      child: SizedBox(
        ...
        child: Scaffold(
          bottomSheet: isNumeric && Platform.isIOS
              ? KeyboardDoneButton(
                  onTap: () => setState(() => isNumeric = false),
                )
              : null,
                ...
                listener: (context, state) {
                  if (state is UserLoading) {
                      ...
                      context
                          ...
                          .updateItemId(
                            vehicleAddEditTypeId:
                                state.loginModel.data!.itemId ?? 0,
                          );
                    ...
                    if (widget.routeString == "Login") {
                      ...
                      if (docState is GetDocumentSuccess) {
                        documentImageModel = docState.documentImageModel;
                      }

                      if ((state.loginModel.data?.gender ?? "").isNotEmpty) {
